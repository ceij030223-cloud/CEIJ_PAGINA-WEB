...
<head>
  ...
  <!-- Estilos propios -->
  <link rel="stylesheet" href="../css/contacto.css?v=1.3" />
...
<main class="contact-main">
  ...
  <div class="contact-wrapper">
    ...
    <form class="contact-form" method="POST" action="correocontacto.php">
      ...
      <div class="input-box textarea">
        ...
        <textarea rows="4" placeholder="Mensaje" name="mensaje" required></textarea>
      </div>
    ...
    <div class="modal-content"
      ...
      <div class="modal-body d-flex align-items-center justify-content-center gap-3">
        ...
        <i class="bi bi-check-circle-fill" 
           style="font-size: 3.2rem; color:#28a745;"></i>

        <div class="text-center">
          <p class="mb-0 fs-5 fw-semibold">
            Tu mensaje ha sido enviado correctamente.
          </p>
          <small class="text-muted">¡Gracias por contactarnos!</small>
        </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content"
      ...
      <div class="modal-body d-flex align-items-center justify-content-center gap-3">
        ...
        <div class="text-center">
          <p class="mb-0 fs-5 fw-semibold">Error al enviar el mensaje.</p>
          <small class="text-muted">Intenta más tarde.</small>
        </div>
...
<div class="main">
  ...
  <?php if (isset($_GET['estado']) && $_GET['estado'] === "exito"): ?>
    <script>
        ...
        // Después de mostrar el modal, limpiar la URL
        window.history.replaceState({}, '', 'contacto.php');
    </script>
    <?php endif; ?>
