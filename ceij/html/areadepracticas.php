...
<head>
  ...
  <link rel="stylesheet" href="../css/areadepracticas.css?v=3.1" />
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css">
  <title>Área de práctica</title>
</head>
<body>
...
<main>
  <section class="entorno-cards">
    <?php
// Obtener tarjetas junto con la posible galería asociada
$query = "
...
<div class="container">
  <div class="row row-cols-1 row-cols-md-3 g-4">
    <?php while ($tarjeta = $resultado->fetch_assoc()): ?>
      <div class="col">
        <div class="card">
          ...
          <div class="card-scroll-content">
            ...
            <div class="card-body">
              <h5 class="card-title"><strong><?= htmlspecialchars($tarjeta['titulo']) ?></strong></h5>
