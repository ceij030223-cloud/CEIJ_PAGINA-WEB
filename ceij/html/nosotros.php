...
<head>
  ...
  <link rel="stylesheet" href="../css/nosotros.css?v=1.1" />
  ...
  <div class="row mb-4">
    ...
    <div class="col-md-6 mb-4">
      <div class="card-custom">
        ...
        <p>En el Centro de Entrenamiento Industrial Juárez nos dedicamos a formar profesionales competentes y comprometidos, 
          ayudando a nuestros estudiantes a alcanzar sus objetivos profesionales y personales. </p>
      </div>
    </div>
    ...
    <div class="col-md-6 mb-4">
      <div class="card-custom">
        ...
        <p>Ayudar a nuestros estudiantes a alcanzar sus objetivos profesionales y personales, 
        y contribuir de manera significativa a la economía local y nacional. Comprometiéndonos con 
        la excelencia académica y la integridad.</p>
      </div>
    </div>
  </div>
  ...
  <div class="row mb-4">
    ...
    <div class="col-md-6 mb-4">
      <div class="card-custom">
        ...
        <p>Ser líder en la formación de profesionales altamente calificados en el sector industrial, 
        promoviendo el desarrollo de competencias técnicas y prácticas para el éxito en su campo laboral, 
        fomentando un ambiente de aprendizaje colaborativo, inclusivo y respetuoso.</p>
      </div>
    </div>
    ...
    <div class="col-md-6 mb-4">
      <div class="card-custom">
        ...
        <p>Los valores que se promueven en el Centro de Entrenamiento Industrial Juárez son la seguridad, 
        la eficiencia, la responsabilidad y la calidad.</p>
      </div>
    </div>
  </div>
